...
**`known-values-ts`** is the registry of ontological predicates used in Gordian Envelope, encoded as compact integers instead of strings.
...
`known-values-ts` is currently under active development and in beta testing. It should not be used for production tasks until it has had further testing and auditing. See [Blockchain Commons' Development Phases](https://github.com/BlockchainCommons/Community/blob/master/release-path.md).
...
`@blockchaincommons/known-values` depends on `@blockchaincommons/components`, `@blockchaincommons/dcbor-compat` at runtime.
...
This `known-values-ts` project is either derived from or was inspired by:
...
As an open-source, open-development community, Blockchain Commons does not have the resources to provide direct support of our projects. Please consider the discussions area as a locale where you might get answers to questions. Alternatively, please use this repository's [issues](https://github.com/BlockchainCommons/known-values-ts/issues) feature. Unfortunately, we can not make any promises on response time.
