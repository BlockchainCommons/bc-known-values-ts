...
[`BlockchainCommons/known-values-ts`](https://github.com/BlockchainCommons/known-values-ts).

For the extraction release, **`1.0.0-beta.1`, the public API is unchanged.** The
migration is a rename. `@bcts/known-values` remains published for one beta cycle as a
